  ...
  $scope.getLocFeed = function(cityName) {
  	...
  	.done(function(result) {
			...
			.done(function(data) {
				...
				//get media from city
				result.get('https://api.instagram.com/v1/media/search?lat=' + lat + '&lng=' + lng + '&client_id=0818d423f4be4da084f5e4b446457044&count=5')
	...
	var getImages = function(data){
	    ...
	    var result = data.images.thumbnail.url;
	    return result;
  	};
