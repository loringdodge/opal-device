      ...
      .done(function (result) {
        ...
        result.get('http://maps.googleapis.com/maps/api/geocode/json?address=' + city + '&sensor=false')
          .done(function (data) {
            ...
            //get media from city
            result.get('https://api.instagram.com/v1/media/search?lat=' + lat + '&lng=' + lng + '&client_id=0818d423f4be4da084f5e4b446457044&count=40')
                ...
                locObjects.data.forEach(function (obj) {
                  ...
                  if (obj.caption) {
                    ...
                    $http.get('https://twinword-sentiment-analysis.p.mashape.com/analyze/?text=' + string, {
                        headers: {
                          'X-Mashape-Key': 'bZKtaWEZMmmshwTi4qO4XJhxvNfCp13uY3yjsnYweDF3s3S2Bw'
                        }
